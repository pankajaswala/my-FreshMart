...
async function loadDashboard() {
    ...
    try {
        ...
        const productRes = await fetch("https://my-freshmart-3.onrender.com/api/products");
...
const description = document.getElementById("description").value.trim();
    try {
        ...
        const response = await fetch("https://my-freshmart-3.onrender.com/api/products", {
...
async function deleteProduct(id) {
    ...
    try {
        ...
        const response = await fetch(`https://my-freshmart-3.onrender.com/api/products/${id}`, {
...
async function loadTotalOrders() {
    ...
    try {
        ...
        const res = await fetch("https://my-freshmart-3.onrender.com/api/orders");
...
async function completeOrder(id) {
    ...
    try {
        ...
        const res = await fetch(`https://my-freshmart-3.onrender.com/api/orders/${id}`, {
